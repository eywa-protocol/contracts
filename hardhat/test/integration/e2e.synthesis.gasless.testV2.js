...
contract('Simple e2e test', (deployer, accounts) => {
    ...
    describe('simple end-to-end test', async () => {
        ...
        it('Simple. ERC20 without permit (through approve)', async () => {
            ...
            // add user private key for to do transatction
            await providerWithGSN.addAccount(process.env.TESTNET_RINKEBY);
            ...
            // transatrion through gsn provider
            ...
            await timeout(40_000); // give some time for execute on sencond blockchain
...
//https://github.com/ibhagwan/pancake-swap-interface-v1
