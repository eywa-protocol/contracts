...
contract('Router', () => {
    ...
    describe("synthesize local test", () => {
        ...
        before(async () => {
            ...
            chainIdC = deployInfo["network3"].chainId
            chainIdB = deployInfo["network2"].chainId
            chainIdA = deployInfo["network1"].chainId
        ...
        it("Emergency Unburn: network1 -> network2(hub)", async function () {
            ...
            await routerB.unsynthesizeRequest(
                synthAddress,
                amount,
                userNet2,
                userNet1,
        ...
        it("Emergency Unburn: network1 -> network3", async function () {
            ...
            await routerC.unsynthesizeRequest(
                synthAddress,
                amount,
                userNet3,
                userNet1,
        ...
        it("Emergency Unburn: network2 -> network1", async function () {
            ...
            await routerA.unsynthesizeRequest(
                synthAddress,
                amount,
                userNet1,
                userNet2,
