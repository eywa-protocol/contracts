...
let TARGET_ADDRESS = '0x..'; // Router address
let targetContractName = 'Router'; /// Router name
let targetFuncSig = 'removeTrustedWorker'; // Router function
let targetArgList = ['0x..']; // params for removeTrustedWorker function
