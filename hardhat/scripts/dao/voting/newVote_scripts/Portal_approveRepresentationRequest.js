...
let TARGET_ADDRESS = '0x..'; // Portal address
let targetContractName = 'Portal'; /// Portal name
let targetFuncSig = 'approveRepresentationRequest'; // Portal function
let targetArgList = ['0x..', '18']; // params for approveRepresentationRequest function
