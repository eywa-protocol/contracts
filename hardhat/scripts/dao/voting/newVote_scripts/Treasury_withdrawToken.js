...
let TARGET_ADDRESS = '0x..'; // EywaTreasury address
let targetContractName = 'EywaTreasury'; /// EywaTreasury name
let targetFuncSig = 'withdrawToken'; // EywaTreasury function
let targetArgList = ['0x..', '1', '0x..']; // params for withdrawToken function
