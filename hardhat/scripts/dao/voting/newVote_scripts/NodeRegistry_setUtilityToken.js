...
let TARGET_ADDRESS = '0x..'; // NodeRegistry address
let targetContractName = 'NodeRegistry'; /// NodeRegistry name
let targetFuncSig = 'setUtilityToken'; // NodeRegistry function
let targetArgList = ['0x..']; // params for setUtilityToken function
