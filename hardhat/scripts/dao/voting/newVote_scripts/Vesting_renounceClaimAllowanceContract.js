...
let TARGET_ADDRESS = '0x..'; // EywaVesting address
let targetContractName = 'EywaVesting'; /// EywaVesting name
let targetFuncSig = 'renounceClaimAllowanceContract'; // EywaVesting function
let targetArgList = ['0x..']; // params for renounceClaimAllowanceContract function
