...
let TARGET_ADDRESS = '0x..'; // Synthesis address
let targetContractName = 'Synthesis'; /// Synthesis name
let targetFuncSig = 'createRepresentation'; // Synthesis function
let targetArgList = ['0x..','0x..','18']; // params for createRepresentation function
