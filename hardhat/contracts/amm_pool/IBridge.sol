...
interface IBridge {
     ...
     function transmitRequestV2_32(bytes memory owner, bytes32 receiveSide, bytes32 oppositeBridge, uint chainID, bytes32 requestId, address sender, uint256 nonce) external returns (bool);
