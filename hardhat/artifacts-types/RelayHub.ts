...
export interface RelayHubInterface extends utils.Interface {
  functions: {
    "G_NONZERO()": FunctionFragment;
    ...
    "innerRelayCall(((address,address,uint256,uint256,uint256,bytes,uint256),(uint256,uint256,uint256,address,address,address,bytes,uint256)),bytes,bytes,(uint256,uint256,uint256,uint256),uint256,uint256)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "G_NONZERO", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "G_NONZERO", data: BytesLike): Result;
...
export interface RelayHub extends BaseContract {
  ...
  functions: {
    G_NONZERO(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    innerRelayCall(
      ...
      gasAndDataLimits: GasAndDataLimitsStruct,
      totalInitialGas: BigNumberish,
      maxPossibleGas: BigNumberish,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    "innerRelayCall(((address,address,uint256,uint256,uint256,bytes,uint256),(uint256,uint256,uint256,address,address,address,bytes,uint256)),bytes,bytes,(uint256,uint256,uint256,uint256),uint256,uint256)"(
      relayRequest: RelayRequestStruct,
      signature: BytesLike,
      approvalData: BytesLike,
      gasAndDataLimits: GasAndDataLimitsStruct,
  ...
  populateTransaction: {
    G_NONZERO(overrides?: CallOverrides): Promise<PopulatedTransaction>;
