...
export interface ProxyAdminHelperInterface extends utils.Interface {
  functions: {
...
export interface ProxyAdminHelper extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ProxyAdminHelperInterface;
